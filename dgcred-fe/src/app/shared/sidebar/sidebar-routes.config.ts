...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Dashboard', icon: 'ft-activity', class: 'has-sub', badge: '2', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
        ...
        submenu: [

            {
                path: '', title: 'Bootstrap', icon: '', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
                    ...
                    { path: '/components/models', title: 'Models', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
