...
public class LeaseControllerTest extends AuthenticatedControllerWrapperTest {
...
//	
//	@Test
//	public void testLeaseCreationCreation() throws Exception {
//		
...
//		
//		ResponseEntity<double[]> getResult = null;
//		getResult =  this.trt.getForEntity("/api/property/midPoint" , double[].class);
//		assertEquals(9, getResult.getBody()[2], 0);
//		
//		// TODO
